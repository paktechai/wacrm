      ...
      if (pendingAvatar) {
        ...
        const { error: uploadError } = await supabase.storage
          ...
          .upload(path, pendingAvatar, {
            // Every upload uses a unique timestamped path, so it can be
            // cached immutably without ever serving an older profile photo.
            // The original file is uploaded directly: no canvas resize or
            // lossy re-encoding is applied.

...
// Invitation links are security-sensitive. Always publish them on the
// validated canonical CRM origin instead of reflecting Host headers supplied
// by a browser or reverse proxy.
